...
class Human : AutonomousMode<Steve>() {
    ...
    private var currentSubmersiblePosition = Vector2d(FieldParams.submersibleX - 20.0, FieldParams.submersibleY + 14)
    ...
    private fun goToAscent(): Action {
        return robot.driveActionBuilder(robot.pose)
            .strafeTo(Vector2d(48.0, 48.0))
            .strafeTo(Vector2d(48.0, 24.0))
            .strafeTo(Vector2d(24.0, 12.0))
            .build()
    }
}