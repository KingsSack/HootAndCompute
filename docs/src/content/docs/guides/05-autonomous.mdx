...
### Add an [AutonomousMode](../../api/Volt/com.lasteditguild.volt.autonomous/-autonomous-mode)

Create a new [AutonomousMode](../../api/Volt/com.lasteditguild.volt.autonomous/-autonomous-mode).
