...
See [Using Built-In Attachments](../05-built-in-attachments) to learn more.
...
The `Robot` class automatically calls the `update()` method on every registered `Attachment` during each tick of your [OpMode](../03-opmodes).
...
- [Create an OpMode](../03-opmodes) that controls your attachment
- [Discover Built-In Attachments](../06-built-in-attachments)
