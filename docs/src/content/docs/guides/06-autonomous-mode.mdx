...
An `AutonomousMode` is a [VoltOpMode](../05-opmodes) that allows you to perform [Actions](../../concepts/01-actions) autonomously.
...
- [Learn about multi-variant Autonomous Modes](../07-multi-autonomous-modes)
