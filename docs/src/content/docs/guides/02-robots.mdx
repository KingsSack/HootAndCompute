...
that contains all [Attachments](kdoc/volt/dev.kingssack.volt.attachment/-attachment) and some [Actions](kdoc/volt/dev.kingssack.volt.action/-action)
that make up a robot.

You should create a new [Robot](../../api/Volt/dev.kingssack.volt.robot/-robot) class for each physical robot you have built.
