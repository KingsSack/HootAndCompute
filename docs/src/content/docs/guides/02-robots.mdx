...
A [Robot](../../api/Volt/com.lasteditguild.volt.robot/-robot) is a class
that contains all [Attachments](kdoc/volt/com.lasteditguild.volt.attachment/-attachment) and some [Actions](kdoc/volt/com.lasteditguild.volt.action/-action)
