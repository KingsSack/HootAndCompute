...
/**
 * A [RoadRunnerMecanumDrivetrain] with a [PinpointLocalizer].
 *
 ...
 */
class RoadRunnerPinpointMecanumDrivetrain(
    ...
    override val localizer = PinpointLocalizer(hardwareMap, params.inPerTick, pose)
}
