...
//                    // Create a SimpleRobotMecanumDrive with default parameters
//                    SimpleRobotWithMecanumDrive(hardwareMap, Pose2d(Vector2d(0.0, 0.0), 0.0))
//                }
//                else -> {
...
//                telemetry: Telemetry
//        ): AutonomousMode {
//            return object : AutonomousMode(telemetry) {
...
//                    // Get parameters
//                    val x =
//                            (config.parameters.find { it.name == "x" }?.value as? Number)
//                                    ?.toDouble()
//                                    ?: 0.0
//                    val y =
//                            (config.parameters.find { it.name == "y" }?.value as? Number)
//                                    ?.toDouble()
//                                    ?: 0.0
//                    val heading =
//                            (config.parameters.find { it.name == "heading" }?.value as? Number)
//                                    ?.toDouble()
//                                    ?: 0.0
//
//                    // Create the action
...
//                    // Get parameters
//                    val seconds =
//                            (config.parameters.find { it.name == "seconds" }?.value as? Number)
//                                    ?.toDouble()
//                                    ?: 1.0
//
...
//                            "Unknown action: ${config.id} for robot type: ${robot.javaClass.simpleName}"
//                    )
//                }
//            }
//        }
